    ...
    <footer className="bg-secondary-900 text-secondary-300 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-secondary-400">
              Your destination for beauty and wellness. Professional services in a relaxing atmosphere.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm mb-2">Monday - Friday: 9AM - 6PM</p>
            <p className="text-sm mb-4">Saturday: 10AM - 4PM</p>
        ...
        <div className="mt-8 pt-8 border-t border-secondary-800 text-center text-sm">
          <p>&copy; {currentYear} Beauty Salon. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
